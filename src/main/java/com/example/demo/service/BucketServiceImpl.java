...
public class BucketServiceImpl implements BucketService{
    ...
    @Override
    public void removeProductAtBucket(Bucket bucket, Long productId) {
        List<Product> products = bucket.getProducts();
        List<Product> newProductList = products != null ? new ArrayList<>(products) : new ArrayList<>(); //todo исправить
        newProductList.remove(productId);
        bucket.setProducts(newProductList);
        bucketRepository.save(bucket);
    }
